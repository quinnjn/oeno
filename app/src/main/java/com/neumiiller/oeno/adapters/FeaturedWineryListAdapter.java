...
public class FeaturedWineryListAdapter extends WineryListAdapter {

    public FeaturedWineryListAdapter(Context context) {
        super(context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        address.setText(winery.getCity());
        city.setText(winery.getMeta().getDetails().getOpenString());
